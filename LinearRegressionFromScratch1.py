...
print("Mean Squared error for my model",meanSquaredErrorPrediction)
linearRegressionScratchObject.showModel(XTest, YTest)
print("Mean squared error from scikit",mean_squared_error(YTest, predictedValues, multioutput='raw_values'))
print("my model r2 score",r2_score(YTest, predictedValues))

reg = LinearRegression()
model = reg.fit(XTrain, YTrain)
print("scikit score r2 error",reg.score(XTest,YTest))
